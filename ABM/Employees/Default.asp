    ...
    <div class="middle">
      ...
      <div>
        ...
        <form method="post" action="Default.asp">
          ...
          <br><br>
          <a href="reports.asp" class="repbtn">
      ...
      <%
      If doAction=1 Then
      Set objRs = searchEmployee(search,EmployeeName,EmployeeLastName,EmployeeRoleID,EmployeeDNI)
      If objRs.EOF Then
      %>
      <div class="msgProcess">
        <h1 class="warning"><i class="fa fa-exclamation-circle"></i> No se han encontrado coincidencias</h1>
      </div>
      <script language="javascript">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="buttons">
              <a href="details.asp?EmployeeID=<%=EmployeeID%>"><img src="../images/notepad.png" class="tableimg" alt="Detalles del empleado" height="30" width="30"></a>
              <a href="add.asp?EmployeeID=<%=EmployeeID%>"><img src="../images/pencil.png" class="tableimg" alt="Modificar empleado" height="30" width="30"> </a>
            </td>
          </tr>
          <%objRs.MoveNext%>
          <% Wend %>
