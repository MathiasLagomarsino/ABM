...
' RME: 2015.05.22: Agrego funciones para nuevo framework de programación. [iPN Framework]. Documentación disponible en https://docs.google.com/a/infiniteloop.com.ar/document/d/16RLgqNck6nUNgQH3KtrQeeSM9UclhLrPpZ0T-Ee0rlo/edit?usp=sharing
...
'Función para poder traer un RS sólo pasándole el nombre del SP a ejecutar y un array con los params
    Dim objConn 'As ADODB.Connection
    Dim objCmd 'As ADODB.Command
    DIm objRs
